...
const PrivacyPolicy = (({ open, close }: ConnectProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <ModalHeader>
          <ModalHeaderContainer>
            <ModalHeaderLabel>Privacy Policy</ModalHeaderLabel>
          </ModalHeaderContainer>
        ...
        <PrivacyContainer>
          ...
          <h2>General</h2>
          <p>By using Keystone Products and Services, you consent to the privacy practices described in this Policy.
          ...
          <p>This Policy is governed by the laws of the Hong Kong SAR without regard to conflict of law principles.
